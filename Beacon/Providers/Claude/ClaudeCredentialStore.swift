...
nonisolated enum ClaudeCredentialResolver {
    ...
    /// 4. Beacon Keychain (com.beacon.claude) for manually entered tokens
...
// MARK: - Beacon-owned Keychain storage (for manually entered tokens)

nonisolated enum ClaudeCredentialStore {
    private static let service = "com.beacon.claude"
