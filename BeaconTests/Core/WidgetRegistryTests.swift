// BeaconTests/Core/WidgetRegistryTests.swift
import SwiftUI
import Testing

@testable import Beacon

// Minimal BeaconWidget implementation for testing
private nonisolated struct StubWidget: BeaconWidget {
    let id: String
...
struct WidgetRegistryTests {
    ...
    @Test("supportedSizes propagated through AnyBeaconWidget")
