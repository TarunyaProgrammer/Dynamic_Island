...
export const { app, session, powerMonitor, nativeImage, systemPreferences, BrowserWindow, Notification, safeStorage, globalShortcut, screen, Menu, Tray, dialog, ipcMain, clipboard } = electron;
