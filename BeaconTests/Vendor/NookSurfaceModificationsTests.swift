// BeaconTests/Vendor/NookSurfaceModificationsTests.swift
//
// Guards the changes Beacon makes to the vendored NookSurface. Re-syncing with a newer
...
//
// See Beacon/Vendor/NookSurface/README.md for what is modified and why.
...
@Suite("NookSurface Beacon modifications")
@MainActor
struct NookSurfaceModificationsTests {
    ...
    func syntheticNotchWidthDefault() {
        ...
        // reads as obviously wrong next to one, which is why Beacon overrides it.
    ...
    func notchMetricsArePublic() {
        ...
        // internal, and Beacon sizes its own compact slots against them.
        let nook = Nook(hoverBehavior: [.keepVisible]) { EmptyView() }
