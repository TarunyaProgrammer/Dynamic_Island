...
//
// Modified for Beacon: the synthetic notch width is a parameter instead of a hardcoded
// 300pt. Beacon draws the notch shape on every Mac, including ones with no physical
