...
// Modified for Beacon: added `compactTopCornerRadius`/`compactBottomCornerRadius` so a host
// can tune the compact pill's roundedness. `NookView.compactCornerRadii` previously ignored
// this struct entirely and hardcoded (6, 14) — Beacon's Atoll-inspired look needs a rounder
