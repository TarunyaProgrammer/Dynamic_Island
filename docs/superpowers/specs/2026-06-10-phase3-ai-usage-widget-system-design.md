# Beacon Phase 3: AI Usage + Widget Preset System Design
...
- `BeaconWidget` protocol — 4 sizes: mini/compact/standard/full
...
Beacon/Core/
  ...
  WidgetProtocol.swift       — BeaconWidget protocol
...
- Keychain for API keys (`com.tukuyomi032.beacon`)
