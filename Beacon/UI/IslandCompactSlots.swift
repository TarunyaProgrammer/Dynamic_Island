...
/// the single ~150pt strip Beacon used to draw inside its own capsule has to be split.
///
...
/// `BeaconWidget` declares, so genericizing it has no real second widget to serve yet.
