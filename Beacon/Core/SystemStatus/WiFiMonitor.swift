...
///
/// `CWInterface.ssid()` requires Location Services authorization on macOS 14+; Beacon
...
/// around a run-loop client Beacon would otherwise have no reason to keep alive, for a
