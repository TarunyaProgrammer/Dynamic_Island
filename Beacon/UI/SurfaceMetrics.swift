...
nonisolated enum SurfaceMetrics {
    ...
    /// (Mirror included). Beacon has no Mirror; 640 is kept anyway as the width that
    ...
    /// on the left). Handbook §4.2 computes height per page from a Resolver; Beacon's Home
